...
<html>
	...
	<body style="margin: 0; font-family: 'Times New Roman', Times, serif; font-size: 10px;" onload="window.prinst();">
					...
					<table width="100%">
						...
						<tr>
							<td>
								...
								<span style="margin-left: 10px;"> RBL-<?php echo str_pad($Kots->bill->voucher_no, 6, "0", STR_PAD_LEFT); ?></span>
							</td>
							<td align="right">
