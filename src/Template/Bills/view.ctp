	...
	<body style="margin: 0; font-family: 'Poppins', sans-serif; font-size: 12px;"  >
		<div style="width: 300px;">
			<div style=" padding: 5px 15px 5px 15px; " id='DivIdToPrint'>
				...
				<div style="border-top: solid 1px #807e7e; border-bottom: solid 1px #807e7e; padding: 0px 0px; line-height: 16px; font-size: 10px;">
					<table width="100%">
						<tr>
							...
							<td align="right">
								<span style="color: #606062; font-size: 12px;">Mobile No: </span>
								<span style="margin-left: 10px; font-size: 12px;"> <?= h(@$bill->customer->mobile_no) ?> </span>
							</td>
						</tr>
					</table>
				</div>	
				<div style=" border-bottom: solid 1px #807e7e; padding: 0; line-height: 14px;font-size: 11px;">
					<table width="100%">
						<tr>
							<td>
						...
						<tr>
							<td>
								<span style="color: #606062; font-size: 13px;">TOKEN No.: </span>
								<span style="margin-left: 10px;font-size: 15px;"> <?php echo $kot_no; ?> </span>
							</td>
							<td align="right">
				...
				<table width="100%" id="billBox" style="line-height: 16px;padding: 0;margin: 0;font-size: 11px;">
					<thead>
						<tr>
					...
					<tfoot style=" line-height: 15px; ">
						...
						<?php if($discountAmount>0){ ?>
							<tr>
								<th style=""></th>
								<th colspan="3" style="text-align:left;">Total <i>Discount</i> </th>
				...
				<div style="font-size: 10px;">
					GSTIN : &nbsp 08ALOPD3505E1ZF
				</div>
				<?php if($discountAmount>0){
					echo '<div style="font-size:14px;text-align:center;"><b>You saved </b><i>'.$discountAmount.'</i><b> Rupees.</b></div>';
				} ?>
				<div>
