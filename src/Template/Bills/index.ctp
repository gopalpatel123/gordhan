                ...
                <form method="GET">
                    <div align="center">
                        <table>
                            <tr>
                                <td valign="bottom">
                                    <input type="text" class="form-control" placeholder="Bill No" name="bill-no" value="<?php echo @$bill_no; ?>">
                                </td>
                                <td valign="bottom">
                                    <?php 
                                    ...
                                    <input class="form-control date-picker" placeholder="From Date" name="from-date" value="<?php echo @$PrintDate1; ?>" data-date-format="dd-mm-yyyy" placeholder="Date" autocomplete="off">
                                </td>
                                <td valign="bottom">
                                    <?php 
                                    ...
                                    <label>To Date</label>
                                    <input class="form-control date-picker" placeholder="To Date" name="to-date" value="<?php echo @$PrintDate2; ?>" data-date-format="dd-mm-yyyy" placeholder="Date" autocomplete="off">
                                </td>
                                <td valign="bottom">
                                    <input type="text" class="form-control" placeholder="Amount From" name="amount-from" value="<?php echo @$amount_from; ?>">
                                </td>
                                <td valign="bottom">
                                    <input type="text" class="form-control" placeholder="Amount to" name="amount-to" value="<?php echo @$amount_to; ?>">
                                </td>
                                <td valign="bottom">
                                    <input type="text" class="form-control" placeholder="Name" name="customer-name" value="<?php echo @$customer_name; ?>">
                                </td>
                                <td valign="bottom">
                                    <input type="text" class="form-control" placeholder="Mobile" name="mobile-no" value="<?php echo @$mobile_no; ?>">
                                </td>
                                <td valign="bottom">
                                    <input type="text" class="form-control" placeholder="Code" name="customer-code" value="<?php echo @$customer_code; ?>">
                                </td>
                                <td valign="bottom">
                            ...
                            <td class="actions">
                                ...
                                <?php
                                    ...
                                    if (in_array("50", $userPages)){
                                        echo $this->Html->link('Re-Print ', '/Bills/view2?bill-id='.$bill->id, ['class' => 'btn btn-xs blue showLoader','target'=>'_blank']); ?>
                                            ...
                                            <form method="post" action="<?php echo $this->Url->build(array('controller'=>'Bills','action'=>'delete',$bill->id)) ?>">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        ...
                                                        <input type="hidden" name="q_path" value="<?php echo $q_path; ?>">
                                                    </div>
