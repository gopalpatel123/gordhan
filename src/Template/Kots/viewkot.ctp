		...
		<div style="width: 300px;">
			<div style="  padding: 5px 15px 5px 15px;  " id='DivIdToPrint'>
					...
					<table width="100%">
						<tr>
							<td>
								...
								<span style="margin-left: 10px;font-size: 16px;"> <?php echo $Kots->voucher_no; ?> </span>
							</td>
							<td align="right">
								<span style="color: #606062;">TOKEN Time: </span>
								<span style="margin-left: 10px;"> <?php echo $Kots->created_on->format('h:i A'); ?> </span>
							</td>
						</tr>
						<tr>
							<td>
								<span style="color: #606062;">TOKEN Date: </span>
						...
						<tr>
							<td>
								...
								<span style="margin-left: 10px;font-size: 12px;"> RBL-<?php echo str_pad($Kots->bill->voucher_no, 6, "0", STR_PAD_LEFT); ?></span>
							</td>
							<td align="right">
				...
				<table width="100%" id="billBox" style="line-height: 20px;padding: 0;margin: 0;">
					<thead>
						<tr>
							<th style="border-bottom: solid 1px;width: 25px;">S.No.</th>
