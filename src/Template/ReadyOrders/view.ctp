...
<!-- BEGIN HEAD -->
	...
	<body class="login" >
		...
		<div class="row" style="margin-left:0px;margin-right:0px;">
			<?php foreach($readyOrderList as $data){ ?>
				
					<div class="col-md-6" style="border:1px solid #ccc;padding:10px;height:328px; background-color:black;color:red;">
						<div class="">
							<div style="font-size:200px; text-align:center;">
									 <?php echo $data->table_no; ?>
							</div>
						</div>
					</div>
