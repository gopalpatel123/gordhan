...
<?php $this->set("title", 'Stock-In Voucher | '.$coreVariable['company_name']); ?>
<style>
	.help-block-error{
		font-size: 12px; 
	}
			...
			<div class="portlet-body">
				<div class="row">
					<div class="form-group col-md-2">
						<label class="control-label" style="padding:0;">Issue Date <span class="required">* </span></label>
					...
					<div class="form-group col-md-4">
						...
						<?php echo $this->Form->input('vendor_id',['options' =>$Vendors,'label' => false,'class'=>'form-control input-sm vendor_select  select2me ','empty'=> '--select--','required'=>'required']);?>
					</div>
					<div class="form-group col-md-3">
						<label class="control-label" style="padding:0;">Invoice No. <span class="required" required name="vandors">*</span></label>
						<?php echo $this->Form->input('invoice_no', ['style'=>'text-align:left','label' => false,'class' => 'form-control input-sm invoice_no','type'=>'text','required'=>'required']); ?>
					</div>
					<div class="form-group col-md-3">
						<label class="control-label" style="padding:0;">Comment. <span class="required" required name="vandors">*</span></label>
						<?php echo $this->Form->control('comment',['class'=>'form-control','label'=>false,'style'=>'resize:none;','rows'=>2]); ?>
					</div>
				</div>
				<div class="row">
...
<!-- BEGIN PAGE LEVEL SCRIPTS -->
	...
	$(document).ready(function() {
		...
		$('.vendor_select').change(function () {
			var employee_id=$('.vendor_select option:selected').val();
			var url='".$this->Url->build(['controller'=>'Vendors','action'=>'supplierWiseItem'])."';
...
<table id="sample" style="display:none;"  width="1500px">
	<tbody class="table_br">
		<tr class="main_tr">
			...
			<td width="15%" align="left" class="vendor_wise_select">
