...
<?php $this->set("title", 'Units | '.$coreVariable['company_name']); ?>
<!-- BEGIN PAGE CONTENT-->
    ...
    <div class="col-md-6">
        ...
        <div class="portlet box blue-hoki">
            <div class="portlet-title">
                ...
                <div class="tools">
                    <?php if(!empty($id)){ ?>
                        <?php echo $this->Html->link('<i class="fa fa-plus"></i> Add ','/Units/add/',array('escape'=>false,'style'=>'color:#fff'));?>
                    <?php }?>
                </div>
                <div class="row">   
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" <?php if(!empty($id)){ echo "value='".$unit->name."'"; } ?> name="name" class="form-control" Placeholder="Enter Unit Name">
                            ...
                            <td class="actions" style="text-align:center">
                                ...
                                <div id="deletemodal<?php echo $country->id; ?>" class="modal fade" role="dialog">
                                    <div class="modal-dialog modal-md" >
                                        <form method="post" action="<?php echo $this->Url->build(array('controller'=>'Units','action'=>'delete',$country->id)) ?>">
