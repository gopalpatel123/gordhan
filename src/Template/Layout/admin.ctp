...
<html lang="en"> 
	<head>
		...
		<?php echo $this->Html->css('/assets/global/plugins/fixed_header/css/fixed_table_rc.css'); ?>
		...
		<link rel="shortcut icon" href="<?php echo $this->Url->build(['controller' =>'/img/mobile.png', '_full'=>true, '_ssl'=>false]); ?>"/>
	</head>
	<!-- END HEAD -->
	<!-- BEGIN BODY -->
	...
	<body class="page-header-fixed page-quick-sidebar-over-content page-container-bg-solid" style="background:#2D4161 !important;font-family: 'Nunito Sans', sans-serif;">
			...
			<div class="page-header-inner">
				...
				<div class="page-logo">
					<a href="#" style="margin-top: 1px;" role="button" style="text-decoration: none !important;">
						...
						<?php echo $this->Html->Image('/img/logodas.png',['style' => 'height: 43px;width: 203px;']); ?>
					</a>
		...
		<?php echo $this->Html->script('/assets/global/plugins/fixed_header/js/fixed_table_rc.js'); ?>
		<!-- END CORE PLUGINS -->
