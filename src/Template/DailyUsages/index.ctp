                            ...
                            <div align="center">
                                <form method="GET">
                                    <table>
                                        <tr>
                                            <td>
                                                <input name="current_date" class="form-control date-picker" type="text" value="<?php echo @$current_date; ?>" data-date-format="dd-mm-yyyy" required="required" placeholder="Month">
                                            </td>
                                            <td>
                        ...
                        <table class="table table-bordered table-stripped" >
                            ...
                            foreach ($rawMaterials as $rawMaterial) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control input-sm" name="quantity[]" placeholder="0" value="" />
