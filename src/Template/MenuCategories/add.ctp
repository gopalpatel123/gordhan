...
<div class="col-md-6">
		...
		<div class="portlet box blue-hoki">
			...
			<div class="portlet-body">
				<div class="">
					<?= $this->Form->create($menuCategory,['id'=>'CountryForm']) ?>
						<div class="form-group">
							...
							<div class="col-md-8">
								<div class="input-icon right">
									<i class="fa"></i>
									<input type="text" <?php if(!empty($id)){ echo "value='".$menuCategory->name."'"; } ?> name="name" class="form-control" Placeholder="Enter Category Name">
								</div>
							</div>
		...
		<div class="portlet box blue-hoki">
			...
			<div class="portlet-body">
				<table class="table table-str table-hover " cellpadding="0" cellspacing="0" id="main_tbody">
					...
					<tbody>
						<?php $x=0; foreach ($menuCategories as $country): ?>
						<tr class="main_tr">
							<td><?= ++$x; ?></td> 
							...
							<td class="actions">
								...
								<div id="deletemodal<?php echo $country->id; ?>" class="modal fade" role="dialog">
									<div class="modal-dialog modal-md" >
										<form method="post" action="<?php echo $this->Url->build(array('controller'=>'MenuCategories','action'=>'delete',$country->id)) ?>">
							    ...
							    <div id="undeletemodal<?php echo $country->id; ?>" class="modal fade" role="dialog">
									<div class="modal-dialog modal-md" >
										<form method="post" action="<?php echo $this->Url->build(array('controller'=>'MenuCategories','action'=>'undelete',$country->id)) ?>">
											<div class="modal-content">
												<div class="modal-header">
													<h4 class="modal-title">
