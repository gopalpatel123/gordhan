...
<?php $this->set("title", 'Item-Sub-Category | '.$coreVariable['company_name']); ?>
<!-- BEGIN PAGE CONTENT-->
		...
		<div class="portlet  box blue-hoki">
			...
			<div class="portlet-body">
				<table class="table table-str " cellpadding="0" cellspacing="0" id="main_tbody">
					...
					<tbody>
						<?php $x=0; foreach ($ItemSubCategoriesList as $country):  ?>
						<tr class="main_tr">
							<td><?= ++$x; ?></td> 
							...
							<td class="actions">
								 <?php
									if($country->is_deleted==0){
										echo $this->Html->link('Edit ', '/ItemSubCategories/add/'.$country->id, ['class' => 'btn btn-xs blue showLoader']);
