...
<?php $this->set("title", 'Raw-Material-Sub-Category | '.$coreVariable['company_name']); ?>
<!-- BEGIN PAGE CONTENT-->
                    ...
                    <?= $this->Form->create($rawMaterialSubCategory,['id'=>'CountryForm']) ?>
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <input type="text" <?php if(!empty($id)){ echo "value='".$rawMaterialSubCategory->name."'"; } ?> name="name" maxlength="50" class="form-control  " Placeholder="Enter Sub Category Name">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <div class="input-icon right">
                                    <i class="fa"></i>
                                    <?php echo $this->Form->input('raw_material_category_id',['options' =>$rawMaterialCategories,'label' => false,'class'=>'form-control select2me selectState','empty'=> 'Select...']);?>
                                </div>
                            </div>
                        </div>
                        ...
                        <tr>
                            ...
                            <td class="actions">
                                 <?php
                                    ...
                                    echo $this->Html->link('Edit ', '/RawMaterialSubCategories/add/'.$country->id, ['class' => 'btn btn-xs blue showLoader']);
                                    echo $this->Html->link('Deactivate ', '#', ['data-target'=>'#deletemodal'.$country->id,'data-toggle'=>'modal','class'=>'btn btn-xs red','data-container'=>'body']);
                                    } else {
