 ...
 *
 * @property \App\Model\Table\MenuSubCategoriesTable|\Cake\ORM\Association\HasMany $MenuSubCategories
 *
 ...
 * @method \App\Model\Entity\MenuCategory|bool saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
...
class MenuCategoriesTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->hasMany('MenuSubCategories', [
